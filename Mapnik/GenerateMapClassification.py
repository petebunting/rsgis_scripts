...
page.render_map(m,"Classification2009Landsat.pdf")
page.render_on_map_scale(m)
#page.render_legend(m)
ctx = page.get_context()
ctx.move_to(170,30)
page.write_text(ctx, "Classification of the 2009 Landsat 5 TM", size=14, fill_color=(0.0, 0.0, 0.0), alignment=None)
page.finish()
