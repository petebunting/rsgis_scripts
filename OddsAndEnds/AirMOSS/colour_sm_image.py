...
gdalFormat = getGDALFormat(args.outimage)
...
</rsgis:commands>'''.format(args.inimage, args.outimage, gdalFormat, args.band)
...
if args.outkmz is not None:
    ...
    subprocess.call('gdal_translate -of KMLSUPEROVERLAY {0} {1}'.format(args.outimage, args.outkmz),shell=True)
