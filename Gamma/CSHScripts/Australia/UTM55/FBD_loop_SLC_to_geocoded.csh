...
foreach dir_name ($list_dir)
  ...
  # to geocode an MLI image to 12.5 m, then the oversampling factor would be 4 in X and Y.
  set ovrsamp_x         = 2
  set ovrsamp_y         = 2
  #
  ...
  # "grep range_samples $dir_name.hh.mli.par". For the resampling we can choose several methods, in this case 
  # we use nearest neighbour, and several image formats, in this case we choose float.
