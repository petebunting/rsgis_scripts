...
class GenerateENVIHeaderLatLong (object):
				...
				for eachLine in parFile:
					...
					if(count == 1):
						...
						if(elements[0] == 'title'):
							...
							#outputParameters.append(str(elements[1]).replace('  decimal degrees', '', str(elements[1]).count('   m'))
							outputParameters.append(re.sub('\s+decimal degrees','',str(elements[1])))
