...
Processed to Level 1.5 (georeffernced product) using scripts developed within the Earth Observation Group at Aberystwyth University (http://www.aber.ac.uk/en/iges/research-groups/earth-observation-laboratory/), and available to download from https://bitbucket.org/petebunting/rsgis_scripts .
